    ...
    public class Mapping : Profile
    {
        public Mapping()
        {
            ...
            CreateMap<Booking, BookingServiceWithIdDTO>()
                ...
                .ReverseMap()
                .ForMember(dest => dest.ReservedTime, opt => opt.MapFrom(src => src.ServiceDate.ToDateTime(TimeOnly.MinValue)));
            ...
            CreateMap<Booking, BokingServiceStatusDTO>()
                ...
                .ForMember(dest => dest.IsTretmentPlan, opt => opt.MapFrom(src => src.ServiceNavigation.ServiceDetailNavigation != null && src.ServiceNavigation.ServiceDetailNavigation.Any()))
                .ForMember(dest => dest.Thumbnail, opt => opt.MapFrom(src => src.ServiceNavigation.Thumbnail))
                .ForMember(dest => dest.TherapistName, opt => opt.MapFrom(src =>
                    src.TherapistNavigation != null && src.TherapistNavigation.UserNavigation != null ?
                    src.TherapistNavigation.UserNavigation.FullName
            ...
            CreateMap<Schedule, BookingStepDetailsDTO>()
               ...
               .ForMember(dest => dest.CheckInCode, opt => opt.MapFrom(src =>
                   Math.Abs(BitConverter.ToInt32(src.Id.ToByteArray(), 0))
                   .ToString()
                   .PadLeft(6, '0')
                   .Substring(0, 6)));
            ...
            CreateMap<EventTicket, TicketViewModel>()
                ...
                .ForMember(dest => dest.EventDate, opt => opt.MapFrom(src => src.EventNavigation.EventDate
                    .ToDateTime(src.EventNavigation.TimeStart)))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status));
